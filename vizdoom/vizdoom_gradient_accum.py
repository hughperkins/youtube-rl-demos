...
# how many episodes between optimization steps
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if (i + 1) % accumulate_episodes == 0:
            b = i // accumulate_episodes
            batch_avg_reward = batch_reward / accumulate_episodes
            batch_avg_loss = batch_loss / accumulate_episodes
